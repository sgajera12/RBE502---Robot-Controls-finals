...
%% True plant parameters (30% mismatch)
alpha = 1.3;
p_true = p_nom;
...
for k = 1:N
    [tau_ad(:,k), pi_hat_dot] = adaptive_controller( ...
        q_ad(:,k), q_dot_ad(:,k), ...
...
sgtitle('Trajectory Tracking - Parameter Evolution (masses)');
